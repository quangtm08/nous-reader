# Execution Plan: Connect Sanctuary UI to Real Database
...
## 3. Verification
- [ ] Launch App.
- [ ] Home screen shows "No books found" (or similar).
- [ ] Click "Import" -> Select EPUB.
- [ ] New book appears in the carousel immediately.
- [ ] "Resume" button works (conceptually - just logs for now).
